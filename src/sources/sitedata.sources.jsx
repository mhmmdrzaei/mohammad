const SITE_DATA ={
    ...
    about_text: '<p>My name is Mohammad. </p><p>I create custom built  accessible and responsive sites for my clients using the latest libraries, tools, and technologies. I aim to bridge the gap between the technology and the client needs regarding their brand and audience in the best light.  </p><p>I’m comfortable writing code using different languages + frameworks. This includes  <span>React</span>, <span>React Redux</span>, <span>GraphQL</span> and <span>Gatsby</span>. I  work with <span>CMS</span> clients and databases regularly to set up  <span>headless sites</span>. I’ve worked extensively with <span>Wordpress</span>, building <span>custom themes</span>, <span>custom post types</span>, and <span>custom widgets</span>  for clients. </p><p>I approach every project I take on as an opportunity — I want to problem solve using creative approaches, taking what I’ve learned as an arts and design enthusiast and applying it to every project. </p><p>Let’s work together!</p>',
    ...
    portfolio: [
      { id: 1, 
        ...
        video_sc:'https://mohammadrezaei.com/siteImages/cc-video-sc.png',
      ...
      { id: 2, 
        ...
        video_sc:'https://mohammadrezaei.com/siteImages/access-widget-sc.png',
      ...
      { id: 3, 
        ...
        web_img:'https://mohammadrezaei.com/siteImages/peripheralreview-1024x624.png',
        mobile_img:'https://mohammadrezaei.com/siteImages/pr-mobile.jpg',
      ...
      { id: 4, 
        ...
        mobile_img:'https://mohammadrezaei.com/siteImages/missed-conncection-mobile.jpg',
      ...
      { id: 6, 
        name: 'Bricks & Glitter',
        job_type:'Web Development',
        web_img:'https://mohammadrezaei.com/siteImages/bricks-glitter-1024x624.png',
        mobile_img:'https://mohammadrezaei.com/siteImages/bricksglittermobile.jpg',
